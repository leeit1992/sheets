...
<div id="page-canculator">
	            ...
	            <div class="uk-grid" data-uk-grid-margin>
	                <div class="uk-width-1-1">
	                    <ul class="uk-tab op-sheet-tabs-js" data-uk-tab="{connect:'#tab_sheet'}">
	                        <li class="uk-active"><a href="#">Sheet 1</a></li>
	                    </ul>
	...
	<div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-small op-add-canculator-js" href="#" data-uk-tooltip="{pos:'left'}"  title="Add new sheet">
